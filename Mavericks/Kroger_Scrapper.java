...
public class Kroger_Scrapper {

    public List<String> scrape(String baseUrl, int totalPages) {
        // Specify the folder path where you want to save the HTML files
        String folderPath = "Kroger_Files" + File.separator;
        ...
        try {
            for (int page_number = 1; page_number <= totalPages; ++page_number) {
                ...
                String fileName = "Kroger_page" + page_number + ".html";
        ...
        Kroger_HTMLPARSER.parseHtmlFiles(folderPath, "kroger.csv");
